...
if(isset($_SESSION['user'])){
  ...
  $global_user = $_SESSION['user'];
  $global_id = $_SESSION['id'];
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  if(isset($_POST['submit-add'])){
    ...
    $sql = "INSERT INTO infos (namee, phone, email, user__id) VALUES ('".$name."', '".$phone."', '".$email."', ".$user_id.")";
...
if($_SERVER["REQUEST_METHOD"] == "GET"){
  ...
  if(isset($_GET['q'])){
    ...
    $sql = "SELECT * FROM infos WHERE namee LIKE '". $q ."%' AND user__id = '".$global_id."' ORDER BY namee";
...
if(isset($ignore)){
  if($ignore == true){
    ...
    // echo "SELECT * FROM infos WHERE user__id = ".$global_id." ORDER BY namee";
    $sql = "SELECT * FROM infos WHERE user__id = ".$global_id." ORDER BY namee";
    $result = $conn->query($sql);
  }
}
...
<body>
  <div class="container">
    <h1 class="my-2 text-center">CONTACTS</h1>
          ...
          <div class="modal-content">
            <div class="modal-body">
              <form action="contacts.php" method="post">
                <input type="hidden" name="user_id" value="<?php echo $global_id; ?>">
